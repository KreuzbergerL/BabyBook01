...
public class ReferenzenFragment extends Fragment {
    ...
    ////////// Matrizen für Größe und Gewicht -> 1. Spalte Alter in Monate --- 2. Spalte Mindestwert --- 3. Spalte Maximalwert //////////
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ////////// Werte für SeekBar einstellen //////////
        seekbar.setMax(60);                     // Das Maximum der SeekBar sind 60 Monate
        seekbar.setProgress(progress);
        seekbar.setX(0);                        // Startwert is bei 0



        ////////// Textfelder für Gewicht und Größe für Jungen setzen, weil der Switch am Anfang auf Junge steht //////////
        ...
        ////////// Ausgewählter Status (Junge oder Mädchen) wird grün, anderer Text wird schwarz //////////
        ...
        ////////// Startgröße des Babys wird festgelegt //////////
        icon.getLayoutParams().height =  200;
        icon.getLayoutParams().width =  200;



        ////////// Wenn sich Wert der SeekBar ändert //////////
        seekbar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int i, boolean fromUser) {
                ...
                ////////// Welchen Wert hat die SeekBar -> bei 0 "Geburt" --- bei einen anderen Wert "Anzahl der Monate" //////////
                progress = i;
                ...
                //////////Welches Geschlecht ist momentan aktiv -> Textboxen und Farben der Geschlechter werden gesetzt //////////
        ...
        ////////// Welches Geschlecht ist derzeit aktiv -> Textboxen und Farben der Geschlechter werden gesetzt //////////
